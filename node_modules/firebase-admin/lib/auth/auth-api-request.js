...
var FIREBASE_AUTH_HEADER = {
    'X-Client-Version': 'Node/Admin/8.0.0',
};
...
var FirebaseAuthRequestHandler = /** @class */ (function () {
     ...
     */
    FirebaseAuthRequestHandler.prototype.getOAuthIdpConfig = function (providerId) {
        if (!auth_config_1.OIDCConfig.isProviderId(providerId)) {
            return Promise.reject(new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_PROVIDER_ID));
        }
        return this.invokeRequestHandler(this.projectConfigUrlBuilder, GET_OAUTH_IDP_CONFIG, {}, { providerId: providerId });
    };
    /**
     ...
     */
    FirebaseAuthRequestHandler.prototype.listOAuthIdpConfigs = function (maxResults, pageToken) {
     ...
     */
    FirebaseAuthRequestHandler.prototype.deleteOAuthIdpConfig = function (providerId) {
        if (!auth_config_1.OIDCConfig.isProviderId(providerId)) {
            return Promise.reject(new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_PROVIDER_ID));
        }
        return this.invokeRequestHandler(this.projectConfigUrlBuilder, DELETE_OAUTH_IDP_CONFIG, {}, { providerId: providerId })
            .then(function (response) {
            // Return nothing.
        });
    };
     ...
     *     configuration.
     */
    FirebaseAuthRequestHandler.prototype.createOAuthIdpConfig = function (options) {
        ...
        return this.invokeRequestHandler(this.projectConfigUrlBuilder, CREATE_OAUTH_IDP_CONFIG, request, { providerId: providerId })
            .then(function (response) {
     ...
     *     configuration.
     */
    FirebaseAuthRequestHandler.prototype.updateOAuthIdpConfig = function (providerId, options) {
        if (!auth_config_1.OIDCConfig.isProviderId(providerId)) {
            return Promise.reject(new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_PROVIDER_ID));
        }
        // Construct backend request.
        ...
        return this.invokeRequestHandler(this.projectConfigUrlBuilder, UPDATE_OAUTH_IDP_CONFIG, request, { providerId: providerId, updateMask: updateMask.join(',') })
            .then(function (response) {
            if (!auth_config_1.OIDCConfig.getProviderIdFromResourceName(response.name)) {
     ...
     */
    FirebaseAuthRequestHandler.prototype.getInboundSamlConfig = function (providerId) {
        if (!auth_config_1.SAMLConfig.isProviderId(providerId)) {
            return Promise.reject(new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_PROVIDER_ID));
        }
        return this.invokeRequestHandler(this.projectConfigUrlBuilder, GET_INBOUND_SAML_CONFIG, {}, { providerId: providerId });
    };
    /**
     ...
     *     configuration and no page token are returned.
     */
    FirebaseAuthRequestHandler.prototype.listInboundSamlConfigs = function (maxResults, pageToken) {
        if (maxResults === void 0) { maxResults = MAX_LIST_PROVIDER_CONFIGURATION_PAGE_SIZE; }
        var request = {
            pageSize: maxResults,
        };
     ...
     */
    FirebaseAuthRequestHandler.prototype.deleteInboundSamlConfig = function (providerId) {
        if (!auth_config_1.SAMLConfig.isProviderId(providerId)) {
            return Promise.reject(new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_PROVIDER_ID));
        }
        return this.invokeRequestHandler(this.projectConfigUrlBuilder, DELETE_INBOUND_SAML_CONFIG, {}, { providerId: providerId })
            .then(function (response) {
            // Return nothing.
        });
    };
     ...
     *     configuration.
     */
    FirebaseAuthRequestHandler.prototype.createInboundSamlConfig = function (options) {
        // Construct backend request.
        var request;
        try {
        ...
        var providerId = options.providerId;
        return this.invokeRequestHandler(this.projectConfigUrlBuilder, CREATE_INBOUND_SAML_CONFIG, request, { providerId: providerId })
            .then(function (response) {
     ...
     *     configuration.
     */
    FirebaseAuthRequestHandler.prototype.updateInboundSamlConfig = function (providerId, options) {
        if (!auth_config_1.SAMLConfig.isProviderId(providerId)) {
            return Promise.reject(new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_PROVIDER_ID));
        }
        // Construct backend request.
        ...
        var updateMask = utils.generateUpdateMask(request);
        return this.invokeRequestHandler(this.projectConfigUrlBuilder, UPDATE_INBOUND_SAML_CONFIG, request, { providerId: providerId, updateMask: updateMask.join(',') })
            .then(function (response) {
            if (!auth_config_1.SAMLConfig.getProviderIdFromResourceName(response.name)) {
